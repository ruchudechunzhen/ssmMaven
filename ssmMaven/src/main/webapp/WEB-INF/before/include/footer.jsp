...
<footer>
	<ul>
		<li>
			<img src="<c:url value="/img/footer_logo.png"/>" alt="" draggable="false">
		</li>
		<li class="mt25">
			<h3>各校区地址</h3>
			<ul>
		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei">
					<br>
					<div>
						<img class="weixin" src="<c:url value="/img/微信公众号.png" />" alt="" draggable="false">
						<img class="weibo" src="<c:url value="/img/微博公众号.png" />" alt="" draggable="false">
					</div>
				</li>
			</ul>
		</li>
...
<div class="mask hidden" id="login">
	<div class="mask_content">
		<div class="mask_content_header">
			<img src="<c:url value="/img/logo.png" />" alt="2333  " class="ma">
		</div>
...
<div class="mask hidden" id="reg">
	<div class="mask_content">
		<div class="mask_content_header">
			<img src=" <c:url value="/img/logo.png" /> "  alt="" class="ma">
		</div>
		<div class="mask_content_body">
