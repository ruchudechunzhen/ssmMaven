                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
								...
								<!-- 用户图片信息为空,展示默认图片-->
								 ...
								 <!-- 用户图片不为空,展示用户自己图片 -->
		                         <img id="avatar" width="200px" height="200px" src="#" alt="">
                        ...
                        <div class="profile_ifo_area">				        
                            ...
                            <input type="hidden" name="email" value="${user.email }">
                                <div class="form_group">
                                    ...
                                    <input type="password" id="oldPassword" name="">
                                </div>
                                <div class="form_group">
                                    <span class="dd">新&#x3000;密&#x3000;码：</span>
                                    <input type="password" id="newPassword"  name="">
                                </div>
                                <div class="form_group">
                                    <span class="dd">确认新密码：</span>
                                    <input type="password" id="newPassword02" name="">
                                </div>
