...
var app = new Vue({
            ...
            "sections": [
                {
                    ...
                    "seconds": 34,
                    "teacher": "舒涛",
                    "teacherAvatar": "https://www.zhiyou100/video/HTML5/tearher/舒涛.jpg",
                    "url": "https://www.zhiyou100/video/HTML5/html5.mp4",
                    "abstract": "智游H5以JavaScript为重心，全面覆盖Web应用热门前端框架！智游H5为前端编程而生！保你高薪就业！智游H5整合Node.Js、PHP、Java、.NET等服务端技术，以全栈角度阐释前端编程的精髓！"
                }
            ]
        }]
    },
    ...
    methods: {
        getData: function () {
            ...
            // 上线时需要修改请求地址
            axios.get('http://www.zhiyou100.com/videos/api/chapters.php?id=' + id)
                .then(function (res) {
